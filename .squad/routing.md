...
|-----------|----------|----------|
| Frontend / UI | Fry | Quiz UI, leaderboard display, Static Web App, React components, timer |
| Backend / API | Bender | Azure Functions, Cosmos DB, SignalR, scoring logic, API endpoints |
